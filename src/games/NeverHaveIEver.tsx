...
const CLEAN_STATEMENTS: string[] = [
  ...
  'eaten a whole rotisserie chicken by myself',
  'named a spider so I would not have to kill it',
  'given directions to a place I had never actually been',
  'lost at rock paper scissors and demanded best of five',
  'stared at a word until it stopped looking like a real word',
  'high-fived the air because they left me hanging',
  'gone in for a handshake during a fist bump',
  'had a full conversation with a wrong number',
  'sung the wrong lyrics confidently for years',
  'mispronounced a word my entire life until someone corrected me',
  'ordered food and forgotten what I ordered by the time it arrived',
  'taken the last cookie and flatly denied it',
  'hoarded takeout sauce packets in a drawer',
  'kept a fortune cookie slip in my wallet for luck',
  'alphabetized something nobody asked me to',
  'made a detailed spreadsheet for something completely trivial',
  'argued with a GPS that turned out to be right',
  'followed a GPS straight into a dead end',
  'circled a parking lot five times for a slightly closer spot',
  'walked confidently into the wrong meeting',
  'joined a call ten minutes late and blamed the calendar invite',
  'worn headphones with no music just to avoid conversation',
  'laughed at a meme in a completely silent waiting room',
  'insisted on a shortcut that took twice as long',
  'refused to ask for help and struggled for an hour',
  'watched a long tutorial to avoid a two minute chore',
  'restarted a device and felt like a tech genius',
  'spent an hour troubleshooting before noticing it was switched off',
  'kept a cable for a device I no longer own',
  'found a mystery remote and could not bring myself to toss it',
  'kept an appliance manual and never once opened it',
  'tried to fix a squeaky door and made it louder',
  'watered a fake plant without realizing',
  'overwatered a plant right into an early grave',
  'hidden snacks from myself and found them months later',
  'eaten the emergency snack and never replaced it',
  'returned an item the day before it went on sale',
  'kept a receipt far longer than the thing it was for',
  'clapped for myself after a perfect parallel park',
  'pretended to read a menu I had already memorized',
  'ordered the same coffee and still hesitated at the counter',
  'kept clicking a pen until someone glared at me',
  'gotten an advert jingle stuck in my head all day',
  'defended a strong opinion about a movie I never finished',
  'fallen asleep to a documentary and dreamed the narration',
  'boiled the kettle and forgot about it three times',
  'put my phone in the fridge by accident',
  'apologized to a robot vacuum for being in its way',
  'lost a thumb war to a child and took it personally',
  'kept a gift bag to reuse and never reused it',
];
...
const SPICY_STATEMENTS: string[] = [
  ...
  'kept a crush a secret from my closest friend',
  'developed feelings for someone right after they got into a relationship',
  'flirted with someone just to keep my skills sharp',
  'kept a text conversation going past midnight knowing I had an early start',
  'planned my whole week around one possible run-in',
  'lied about my plans to keep a night open for someone',
  'pretended a song did not remind me of an ex when it absolutely did',
  'kept a playlist named after someone I never even dated',
  'made eye contact across a bar and completely lost my nerve',
  'let a chat with a stranger drift somewhere flirty',
  'given someone a second glance and hoped they caught it',
  'started a flirty text, chickened out, and sent a meme instead',
  'kept a flirty text unopened just to savor the anticipation',
  'replayed a voicemail from a crush more than once',
  'caught myself smiling at a text during a serious meeting',
  'flirted back with someone purely because I was bored',
  'faked interest in a documentary just to sit next to someone',
  'checked a guest list to see if a certain someone was coming',
  'lingered outside so a crush and I would walk in together',
  'let someone borrow something just so they would have to return it',
  'planned an excuse in advance to see someone again',
  'agreed to a group hangout only to see one specific person',
  'felt a flash of jealousy watching a crush talk to someone else',
  'pretended not to care when a crush flirted with someone else',
  'watched a crush\'s story twice to catch a detail I missed',
  'kept a crush\'s notifications on so I never missed a post',
  'kept a screenshot of a dating profile I liked',
  'rehearsed a first dating-app message a dozen times',
  'matched with someone and let the chat die out of pure nerves',
  'unmatched someone the moment they finally replied',
  'set up a date and then secretly hoped they would cancel',
  'chose a fancy spot on a date just to seem impressive',
  'lied about loving a cuisine to impress a date',
  'let a date pick the movie just to seem easygoing',
  'held eye contact a second too long entirely on purpose',
  'offered to share a dessert just to lean in closer',
  'complimented someone out of nowhere just to watch them smile',
  'missed the last bus because I did not want a date to end',
  'lost all track of time talking to someone I liked',
  'sent a good-morning text and pretended it was casual',
  'timed my reply to be exactly as long as they made me wait',
  'wrote three paragraphs and sent a single emoji instead',
  'kept a running tally of who texted first',
  'hit send and instantly wished the app had an undo button',
  'left someone on read on purpose to seem mysterious',
  'rekindled a crush the moment I saw they were single again',
  'wondered if a first love still remembers my name',
  'kept an ex on my close friends list far too long',
  'zoomed in on a photo to check if a crush was holding someone\'s hand',
  'felt my stomach drop when a crush mentioned a date with someone else',
];
