...
export const TRANSLATIONS: Record<string, Record<Lang, string>> = {
  ...
  people_cta_desc: { en: 'Friends, partner, teams & live games — all here', sw: 'Marafiki, mpenzi, timu & michezo ya moja kwa moja' },
  ...
  play_local_audio: { en: 'Play local audio (MP3)', sw: 'Cheza sauti za kwenye simu (MP3)' },
  local_audio: { en: 'Local', sw: 'Za Simu' },
  ...
  bass: { en: 'Bass', sw: 'Bass' },
  mid: { en: 'Mid', sw: 'Kati' },
  treble: { en: 'Treble', sw: 'Juu' },
  reverb: { en: 'Reverb / Space', sw: 'Mwangwi / Nafasi' },
  speed: { en: 'Speed', sw: 'Kasi' },
  speed_note: { en: 'Speed applies to local audio files', sw: 'Kasi inatumika kwa sauti za kwenye simu' },
  ...
  game_load_failed_body: { en: 'Your connection may be weak. Try again, or pick another game.', sw: 'Huenda mtandao ni dhaifu. Jaribu tena, au chagua mchezo mwingine.' },
  try_again: { en: 'Try again', sw: 'Jaribu tena' },
  back_to_games: { en: 'Back to games', sw: 'Rudi kwenye michezo' },
